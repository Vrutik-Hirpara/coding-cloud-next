...
const [isEnrollOpen, setIsEnrollOpen] = useState<boolean>(false);
  ...
  return (
    <motion.header
      ...
      className={`sticky top-0 z-[999] bg-white transition-shadow duration-300 ${scrolled ? "shadow-lg" : "shadow-sm"
        }`}
    >
...
//                                 className="w-full text-left flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg hover:bg-gray-50 transition-all border border-transparent hover:border-gray-200"
//                               >
//                               <div className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 rounded-full overflow-hidden bg-gray-50 flex-shrink-0">
//   <Image
