...
//                         <p className="text-5xl font-bold text-[var(--color-primary)]">5.0</p>
//                         <Stars count={5} />
...
//                     {/* REVIEW ITEM */}
//                     {[
//                         { name: "Farjana Bawnia", img: user1 },
//                         { name: "Razwan Islam", img: user2 },
//                         { name: "Babor Azom", img: user3 },
//                     ].map((u, i) => (
...
//                                     My favorite compliment is being told that I look like my mom.
//                                     Seeing myself in her image, like this daughter up top.
//                                 </p>
